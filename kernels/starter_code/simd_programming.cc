        ...
        for (int col = 0; col < n; col++) {
            ...
            for (int q = 0; q < num_block; q += 2) {
                ...
                */
                ...
                // lower half weights
                __m256i w_0_uint = _mm256_and_si256(raw_w, lowMask);
                // int8 lower half weights
                __m256i w_16_uint = _mm256_and_si256(_mm256_srli_epi16(raw_w, 4), lowMask);
                ...
                __m256i w_0, w_128;
                // weights with int8 [0,]
                w_0 = _mm256_sub_epi8(w_0_uint, zero_point);
                w_128 = _mm256_sub_epi8(w_16_uint, zero_point);
